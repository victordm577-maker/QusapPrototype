...
{
    internal static class QusapPlayablePlayModeLogCapture
    {
        ...
        private static void BeginCapture()
        {
            ...
            string relative = Path.Combine(
                "_Qusap", "Tests", "NewQusap75KAnimationTest", "Playable", "Validation", "PlayModeConsole.log");
            ...
            try
            {
                ...
                File.WriteAllText(logPath, "QUSAP75K_PLAYABLE_PLAYMODE_LOG\n");
        ...
        private static void OnLogMessage(string condition, string stackTrace, LogType type)
        {
            ...
            try
            {
                ...
                File.AppendAllText(logPath, $"{type.ToString().ToUpperInvariant()}|{cleanCondition}|{cleanStack}\n");
            }
            catch
            {
                // Validation logging must never affect gameplay or Play Mode.
            }
        }
    }
}
